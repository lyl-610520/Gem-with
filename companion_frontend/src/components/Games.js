...
const GameTitleModal = styled.h2`
  font-size: 1.5rem; font-weight: 600; color: ${props => props.theme.text};
`;
const CloseButton = styled.button`
  background: none; border: none; color: ${props => props.theme.textLight};
...
const GameInfo = styled.div`
  display: flex; justify-content: space-between; margin-bottom: 20px; font-size: 1.1rem; color: ${props => props.theme.text};
`;
...
const Button = styled.button`
  ...
  ${props => props.primary ? `
    background: ${props.theme.primary}; color: white;
    &:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(99, 102, 241, 0.3); }
  ` : `
    background: transparent; color: ${props.theme.textLight}; border: 2px solid ${props.theme.border};
    &:hover { border-color: ${props.theme.primary}; color: ${props.theme.primary}; }
  `}
`;
